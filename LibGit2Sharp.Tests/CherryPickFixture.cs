    ...
    public class CherryPickFixture : BaseFixture
    {
        ...
        public void CanCherryPick(bool fromDetachedHead)
        {
            ...
            using (var repo = new Repository(path))
            {
                ...
                CherryPickResult result = repo.CherryPick(commitToMerge);
        ...
        public void CherryPickWithConflictDoesNotCommit()
        {
            ...
            using (var repo = new Repository(path))
            {
                ...
                CherryPickResult cherryPickResult = repo.CherryPick(repo.Branches["FirstBranch"].Tip);
        ...
        public void CanSpecifyConflictFileStrategy(CheckoutFileConflictStrategy conflictStrategy)
        {
            ...
            using (var repo = new Repository(path))
            {
                ...
                CherryPickResult result = repo.CherryPick(branch.Tip, cherryPickOptions);
        ...
        private const string cherryPickedCommitId = "4dfaa1500526214ae7b33f9b2c1144ca8b6b1f53";
    }
}
